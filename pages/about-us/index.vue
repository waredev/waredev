    ...
    <div class="bg-light-blue xl:px-20 px-10 py-20">
      ...
      <div class="grid lg:grid-cols-3 grid-cols-none grid-rows-3 lg:grid-rows-none py-10">
        <div class="flex flex-col items-center">
          <div class="w-72 mb-5">
              <img src="~assets/images/teams/dudi.jpg" class="w-72 h-80 object-cover rounded-md" />
        ...
        <div class="flex flex-col items-center">
          <div class="w-72 mb-5">
            <img src="~assets/images/teams/andi.jpg" class="w-72 h-80 object-cover rounded-md" />
        ...
        <div class="flex flex-col items-center">
          <div class="w-72 mb-5">
            <img src="~assets/images/teams/pranto.jpg" class="w-72 h-80 object-cover rounded-md" />
