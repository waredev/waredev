    ...
    <div class="absolute inset-0 lg:mt-10 lg:mx-auto lg:px-20 px-5">
      <div class="bg-gradient-to-r from-[#1a2e44] to-[#2c3e50] lg:h-44 h-auto lg:rounded-2xl flex lg:flex-row flex-col items-center justify-between lg:py-8 py-10 px-10 shadow-lg">
        ...
        <div class="text-center lg:text-left">
          <h3 class="font-bold text-3xl text-white">Let's make something creative</h3>
          <p class="text-white mt-2 text-lg">
            Reach out to us and we will help you organize the right action for your business needs.
          </p>
        </div>

        <a
          rel="noopener noreferrer"
          href="https://wa.me/6282193758418?text=Halo%2C%0ASaya%20tertarik%20untuk%20membuat%20janji%20konsultasi%20dengan%20Waredev%20Digital%20Solution.%0ATerima%20kasih."
          class="bg-white text-[#1a2e44] w-64 h-14 cursor-pointer hover:bg-[#FF914D] hover:text-white duration-300 mt-6 lg:mt-0 flex items-center justify-center font-bold text-xl rounded-lg shadow-md transition-transform transform hover:scale-105"
        >
          Hire Developers
        </a>
      </div>
