<template>
    <section class="pt-32 xl:px-20 px-10 font-nunito mb-20">
    <div class="mb-8">
      <div class="font-bold text-md text-word text-3xl">Our Services</div>
  ...
  import MobileDevelopment from './mobile-development.vue';
