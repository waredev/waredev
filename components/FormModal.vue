<template>
  <div class="fixed z-50 top-0 bottom-0 w-screen h-screen bg-black bg-opacity-50 flex items-center justify-center">
    <div class="bg-white rounded-xl w-[45rem] h-[38rem] relative" @click.stop>
      ...
      <div class="grid grid-cols-2 h-full">
        <img src="~assets/images/3WBHAgicGKZEGKwdGjMxH-transformed.png" class="h-full object-cover rounded-l-xl">
