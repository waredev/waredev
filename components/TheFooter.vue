<template>
	<footer class="px-4 pt-10 divide-y dark:bg-gray-800 dark:text-gray-100 font-nunito">
		<div class="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
          ...
          <div class="font-nunito font-extrabold text-[#333333g] text-2xl ml-2 mt-3">Waredev</div>
				</a>
			</div>
			<div class="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4 font-nunito">
				<div class="space-y-3">
					<h3 class="tracking-wide uppercase dark:text-gray-50 font-nunito">Product</h3>
		...
		<div class="py-6 text-sm text-center dark:text-gray-400">© CV. Waredev Digital Solution. All rights reserved.</div>
	</footer>
</template>
<script>
export default {
