  ...
  <div class="h-screen relative bg-light-blue">
    ...
    <div  class="z-10 relative pt-40 flex items-center lg:px-20 px-10">
      <div class="lg:pr-20 pr-0">
        <div data-aos="fade-right" data-aos-duration="2000"  class="lg:text-5xl text-4xl font-nunito font-bold text-[#333333] mb-8 leading-tight lg:text-left text-center">Empowering Your Business with Innovative Software Solutions.</div>
        <div data-aos="fade-right" data-aos-delay="200" data-aos-duration="2000"  class="font-nunito font-regular text-[#888888] lg:text-left text-center">Unlock your business's full potential with our expert IT consultancy. Our team expertise to help your business stay ahead of the curve.</div>
      ...
      <div data-aos="fade-up" data-aos-duration="3000"  class="hidden lg:flex">
        <nuxt-img src="/img-hero.webp" class="w-[63rem]" />
      </div>
    </div>
  </div>
</template>
