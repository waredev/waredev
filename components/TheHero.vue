<template>
  <div class="h-screen relative bg-light-blue">
    <nuxt-img src="/bg-pattern.webp" class="w-[45.25rem] h-[35.5rem] absolute z-0" placeholder />
    <div class="z-10 relative pt-40 flex items-center lg:px-20 px-10">
      <div class="lg:pr-20 pr-0">
        ...
        <div class="flex lg:flex-row flex-col lg:space-x-5 space-x-0 items-center lg:space-y-0 space-y-3 mt-14">
          ...
          <button class="bg-transparent h-16 px-5 rounded-lg font-nunito font-semibold text-primary text-lg border-[2px] border-primary hover:bg-primary hover:text-white duration-150">Schedule a Consultation</button>
        </div>
      </div>
      <div class="hidden lg:flex">
        <nuxt-img src="/img-hero.webp" class="w-[63rem]" placeholder />
      </div>
    </div>
  </div>
</template>
