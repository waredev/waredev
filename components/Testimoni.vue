  ...
  <section class="relative lg:pt-[70px] lg:mt-10 lg:pb-[20px] font-nunito w-full h-[900px] bg-[#f8f8ff]">
    ...
    >
      <div class="mx-auto text-center md:max-w-xl lg:max-w-3xl">
        <h3 class="mb-4 text-4xl font-extrabold text-[#0a1060] uppercase">
          Testimonials
        </h3>
      ...
      <!--First Testimonial-->
      <div class="grid gap-10 text-center lg:grid-cols-3">
        <div>
          <div
            class="block rounded-lg bg-white custom-shadow dark:bg-neutral-700 dark:shadow-black/30"
          >
